...
PlasmaExtras.PlasmoidHeading {
    ...
    PC3.TabBar {
        ...
        PC3.TabButton {
            ...
            text: i18nc("@title:tab mosLauncher sidebar tab", "Applications") // qmllint disable unqualified
            Keys.onBacktabPressed: event => {
                (mosLauncher.lastCentralPane || nextItemInFocusChain(false))
        ...
        PC3.TabButton {
            ...
            icon.height: Kirigami.Units.iconSizes.smallMedium
            icon.name: "compass"
            text: i18nc("@title:tab mosLauncher sidebar tab", "Places") //Explore? // qmllint disable unqualified
        }
        ...
        Keys.onUpPressed: event => {
            mosLauncher.firstCentralPane.forceActiveFocus(Qt.BacktabFocusReason);
        }
    }
    ...
    LeaveButtons {
        ...
        Keys.onUpPressed: event => {
            mosLauncher.lastCentralPane.forceActiveFocus(Qt.BacktabFocusReason);
        }
    }

    Behavior on height {
        enabled: mosLauncher.expanded
        NumberAnimation {
