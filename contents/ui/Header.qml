...
PlasmaExtras.PlasmoidHeading {
    ...
    contentHeight: layoutContainer.height
        + mosLauncher.backgroundMetrics.topPadding
        + mosLauncher.backgroundMetrics.bottomPadding

    KCoreAddons.KUser {
        id: kuser
    }

    spacing: mosLauncher.backgroundMetrics.spacing
        ...
        Item {
            ...
            RowLayout {
                ...
                KirigamiComponents.AvatarButton {
                    ...
                    Keys.onTabPressed: event => {
                        root.tabSetFocus(event, mosLauncher.firstCentralPane);
                    }
                    ...
                    Keys.onDownPressed: event => {
                        if (mosLauncher.sideBar) {
                            mosLauncher.sideBar.forceActiveFocus(Qt.TabFocusReason)
                        } else {
                            mosLauncher.contentArea.forceActiveFocus(Qt.TabFocusReason)
                        }
                    }
                ...
                MouseArea {
                    ...
                    Kirigami.Heading {
                        ...
                        horizontalAlignment: mosLauncher.paneSwap ? Text.AlignRight : Text.AlignLeft
            ...
            RowLayout {
                ...
                PlasmaExtras.SearchField {
                    ...
                    Layout.fillWidth: true
                    Layout.leftMargin: mosLauncher.backgroundMetrics.leftPadding
                    focus: true
                    ...
                    Keys.forwardTo: {
                        if (mosLauncher.contentArea === null) {
                            return []
                        }
                        if (mosLauncher.contentArea instanceof ListOfGridsView) {
                            // forward to grid inside of list, or down will skip the whole grid'
                            return [mosLauncher.contentArea.view.currentItem?.view, mosLauncher.contentArea.view]
                        }
                        return mosLauncher.contentArea.view
                    }
                ...
                PC3.ToolButton {
                    ...
                    Keys.onLeftPressed: event => {
                        (mosLauncher.sideBarOnRight ? pinButton : searchField).forceActiveFocus(
                            Application.layoutDirection == Qt.RightToLeft ? Qt.TabFocusReason : Qt.BacktabFocusReason)
                    }
                    Keys.onRightPressed: event => {
                        (mosLauncher.sideBarOnRight ? searchField : pinButton).forceActiveFocus(
                            Application.layoutDirection == Qt.RightToLeft ? Qt.BacktabFocusReason : Qt.TabFocusReason)
                    }
                ...
                PC3.ToolButton {
                    ...
                    Keys.onTabPressed: event => {
                        tabSetFocus(event, nextItemInFocusChain(false), mosLauncher.firstCentralPane || nextItemInFocusChain());
                    }
                    Keys.onBacktabPressed: event => {
