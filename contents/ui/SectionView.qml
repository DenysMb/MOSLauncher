...
MosGridView {
    ...
    property MosListView parentView
    ...
    view.cellWidth: Math.floor((view.implicitWidth - view.leftMargin - view.rightMargin) / (mosLauncher.minimumGridRowCount * 1.75))
    ...
    delegate: PC3.AbstractButton {
        ...
        background: Loader {
            ...
            sourceComponent: PlasmaExtras.Highlight {
                ...
                active: root.view.activeFocus || (mosLauncher.contentArea === root && mosLauncher.searchField.activeFocus)
            }
        }
