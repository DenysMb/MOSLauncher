...
BasePage {
    ...
    contentAreaComponent: MosListView {
        id: contentArea
        mainContentView: true
        focus: true
        objectName: "frequentlyUsedView"
        model: switch (root.sideBarItem.currentIndex) {
            case 0: return mosLauncher.computerModel
            case 1: return mosLauncher.recentUsageModel
            case 2: return mosLauncher.frequentUsageModel
        }
    ...
    ListModel {
        ...
        Component.onCompleted: {
            ...
            if (MosSingleton.powerManagement.data["PowerDevil"]
                && MosSingleton.powerManagement.data["PowerDevil"]["Is Lid Present"]) {
